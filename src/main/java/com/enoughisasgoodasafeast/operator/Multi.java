...
public class Multi {
    ...
    static class Present {
        ...
        public static Script evaluate(Session session, MOMessage moMessage) throws IOException {
            ...
            String mtText = renderForPlatform(moMessage.platform(), session.currentScript().text());
            MTMessage mt = MTMessage.create(moMessage, mtText);
            session.sendBuffered(mt);
            return advance(session);
        }

        static String renderForPlatform(Platform platform, String mtText) {
    ...
    static class Process {
        ...
        public static Script evaluate(Session session, MOMessage moMessage) {
            ...
            session.sendBuffered(MTMessage.create(moMessage, UNEXPECTED_INPUT_MESSAGE));
